...
WebUI.selectOptionByLabel(findTestObject('Admin/Desembolso/select_Marca'), GlobalVariable.Marca_CU, false)
...
WebUI.enhancedClick(findTestObject('Admin/Desembolso/select_SeleccionarCuenta'))

WebUI.sendKeys(findTestObject('Admin/Desembolso/select_SeleccionarCuenta'), Keys.chord(Keys.ARROW_DOWN, Keys.ENTER))
...
WebUI.takeFullPageScreenshot("C:/Users/nicolas.aquino/Desktop/Trabajo/Screenshots Katalon/$GlobalVariable.cedulaRandom/3_Desembolso.jpg")
