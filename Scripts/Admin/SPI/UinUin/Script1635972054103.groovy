...
WebUI.selectOptionByLabel(findTestObject('Admin/SPI/Alta de cuenta - SPI/select_Marca'), GlobalVariable.Marca_UU, false)

WebUI.enhancedClick(findTestObject('Admin/SPI/Alta de cuenta - SPI/button_Obtener'))

WebUI.waitForElementPresent(findTestObject('Admin/SPI/Alta de cuenta - SPI/i_AgregarCuenta'), 0)

WebUI.enhancedClick(findTestObject('Admin/SPI/Alta de cuenta - SPI/i_AgregarCuenta'))

WebUI.setText(findTestObject('Admin/SPI/Alta de cuenta - SPI/input_Cuenta'), findTestData('DatosUsuario').getValue(2, 10))

WebUI.enhancedClick(findTestObject('Admin/SPI/Alta de cuenta - SPI/button_AgregarCuenta'))
