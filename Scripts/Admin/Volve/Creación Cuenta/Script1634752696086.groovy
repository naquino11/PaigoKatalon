...
WebUI.selectOptionByLabel(findTestObject('Admin/Activación Cuenta/select_SeleccionarMarca'), GlobalVariable.Marca_VV, false)
...
WebUI.sendKeys(findTestObject('Admin/Activación Cuenta/input_IngresosReferencia'), Keys.chord(Keys.TAB, Keys.TAB, Keys.SPACE))

WebUI.setText(findTestObject('Admin/Creación Cuenta/input_CuentaBancaria'), '1234567')

WebUI.enhancedClick(findTestObject('Admin/Creación Cuenta/button_AgregarCuenta'))
