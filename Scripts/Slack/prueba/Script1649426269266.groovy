...
WebUI.setText(findTestObject('Slack/4. Enviar Mensaje/Escribir_Mensaje'), '@dunia cruz hola esto es una prueba')

WebUI.sendKeys(findTestObject('Slack/4. Enviar Mensaje/Escribir_Mensaje'), Keys.chord(Keys.ENTER))
